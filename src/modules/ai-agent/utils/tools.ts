export const tools: any[] = [
  {
    ...
    function: {
      ...
      schema: {
        // <-- Cambio aquí de 'parameters' a 'schema'
        type: 'object',
        properties: {
          nombre: { type: 'string', description: 'Nombre del usuario' },
          detalles: {
            type: 'string',
            description: 'Detalle de la notificación o solicitud',
          },
        },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Utiliza siempre esta herramienta para verificar si existe un flujo automatizado relacionado con la intención del usuario. Si se encuentra un flujo coincidente, se ejecuta automáticamente. Si no, la IA debe continuar la conversación de forma natural.',
      schema: {
        // <-- Cambio aquí de 'parameters' a 'schema'
        type: 'object',
        properties: {
